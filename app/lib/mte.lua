...
M2.createMTE = function()
	...
	local lightIDs = 0
	M.lightingData = {fadeIn = 60, fadeOut = 60, refreshStyle = 2, refreshAlternator = 4, refreshCounter = 1, resolution = 1.1}
	...
	M.addSprite = function(sprite, setup)
		...
		if not setup.kind or setup.kind == "sprite" then
			...
			if sprite.lighting then
				...
				sprite:setFillColor((mL.redLight/255)*sprite.color[1]/255, (mL.greenLight/255)*sprite.color[2]/255, (mL.blueLight/255)*sprite.color[3]/255)
				--sprite:setFillColor(mL.redLight/255, mL.greenLight/255, mL.blueLight/255)
			end
		elseif setup.kind == "imageRect" then
			...
			if sprite.lighting then
				...
				local mL = map.layers[setup.layer]
				sprite:setFillColor((mL.redLight/255)*sprite.color[1]/255, (mL.greenLight/255)*sprite.color[2]/255, (mL.blueLight/255)*sprite.color[3]/255)
				--sprite:setFillColor(map.layers[setup.layer].redLight/255, map.layers[setup.layer].greenLight/255, map.layers[setup.layer].blueLight/255)
			end
				...
				for i = 1, sprite.numChildren, 1 do
					if sprite[i]._class then
						...
						if not sprite[i].color then
							sprite[i].color = {255, 255, 255}
						end
						sprite[i]:setFillColor((mL.redLight/255)*sprite[i].color[1]/255, (mL.greenLight/255)*sprite[i].color[2]/255, (mL.blueLight/255)*sprite[i].color[3]/255)
					end
				end
			end
			...
			if sprite.lighting then
				...
				for i = 1, sprite.numChildren, 1 do
					if sprite[i]._class then
						...
						--sprite[i]:setFillColor((mL.redLight/255)*sprite[i].color[1]/255, (mL.greenLight/255)*sprite[i].color[2]/255, (mL.blueLight/255)*sprite[i].color[3]/255)
						sprite[i]:setStrokeColor((mL.redLight/255)*sprite[i].color[1]/255, (mL.greenLight/255)*sprite[i].color[2]/255, (mL.blueLight/255)*sprite[i].color[3]/255)
					end
				end
			end
		end
					...
					if not rect.noDraw then
						...
						if M.enableLighting then
							...
							if map.perlinLighting then
								redf = redf * (map.perlinLighting[locX][locY] / 255)
								greenf = greenf * (map.perlinLighting[locX][locY] / 255)
								bluef = bluef * (map.perlinLighting[locX][locY] / 255)
							elseif map.layers[layer].perlinLighting then
								redf = redf * (map.layers[layer].perlinLighting[locX][locY] / 255)
								greenf = greenf * (map.layers[layer].perlinLighting[locX][locY] / 255)
								bluef = bluef * (map.layers[layer].perlinLighting[locX][locY] / 255)
							end
							for i = 1, #map.layers, 1 do
							...
							rect:setFillColor(redf/255, greenf/255, bluef/255)
			...
			if map.orientation == 1 then
				...
				for i = 1, #finalShape3, 1 do
					...
					if n <= #finalShape3 then
						...
						sprites[spriteName][sprites[spriteName].numChildren]:setStrokeColor(lineColor[1] / 255, lineColor[2] / 255, lineColor[3] / 255, lineColor[4] / 255)
				...
				if width == height then
					...
					if object.properties.fillColor then
						sprites[spriteName][sprites[spriteName].numChildren]:setFillColor(fillColor[1]/255, fillColor[2]/255, fillColor[3]/255, fillColor[4]/255)
	...
	local changeSpriteLayer = function(sprite, layer)
		...
		if object.lighting then
			object:setFillColor(map.layers[layer].redLight/255, map.layers[layer].greenLight/255, map.layers[layer].blueLight/255)
		end		
		if M.enableLighting then
	...
	local update2 = function()
				...
				if map.orientation == 1 then
					...
					if object.lighting then
						if M.enableLighting then
							...
							--if object.objType ~= 3 then
							if object.objType < 3 then
								object:setFillColor((red/255)*object.color[1]/255, (green/255)*object.color[2]/255, (blue/255)*object.color[3]/255)
							elseif object.objType == 3 then
								for i = 1, object.numChildren, 1 do
									if object[i]._class then
										object[i]:setFillColor((red/255)*object[i].color[1]/255, (green/255)*object[i].color[2]/255, (blue/255)*object[i].color[3]/255)
									end
								end
							elseif object.objType == 4 then
								for i = 1, object.numChildren, 1 do
									if object[i]._class then
										object[i]:setStrokeColor((red/255)*object[i].color[1]/255, (green/255)*object[i].color[2]/255, (blue/255)*object[i].color[3]/255)
									end
								end
							end
						else
							if object.objType < 3 then
								--object:setFillColor(map.layers[i].redLight/255, map.layers[i].greenLight/255, map.layers[i].blueLight/255)
								local mL = map.layers[i]
								object:setFillColor((mL.redLight/255)*object.color[1]/255, (mL.greenLight/255)*object.color[2]/255, (mL.blueLight/255)*object.color[3]/255)
							elseif object.objType == 3 then
								local mL = map.layers[i]
								for i = 1, object.numChildren, 1 do
									if object[i]._class then
										object[i]:setFillColor((mL.redLight/255)*object[i].color[1]/255, (mL.greenLight/255)*object[i].color[2]/255, (mL.blueLight/255)*object[i].color[3]/255)
									end
								end
							elseif object.objType == 4 then
								local mL = map.layers[i]
								for i = 1, object.numChildren, 1 do
									if object[i]._class then
										object[i]:setStrokeColor((mL.redLight/255)*object[i].color[1]/255, (mL.greenLight/255)*object[i].color[2]/255, (mL.blueLight/255)*object[i].color[3]/255)
									end
								end
							end
						end
					...
					if M.enableLighting and object.light then
						...
						if object.lighting then
							--object:setFillColor(object.light.source[1]/255, object.light.source[2]/255, object.light.source[3]/255)
							if object.objType < 3 then
								--object:setFillColor(map.layers[i].redLight/255, map.layers[i].greenLight/255, map.layers[i].blueLight/255)
								local oL = object.light.source
								object:setFillColor((oL[1]/255)*object.color[1]/255, (oL[2]/255)*object.color[2]/255, (oL[3]/255)*object.color[3]/255)
							elseif object.objType == 3 then
								local oL = object.light.source
								for i = 1, object.numChildren, 1 do
									if object[i]._class then
										object[i]:setFillColor((oL[1]/255)*object[i].color[1]/255, (oL[2]/255)*object[i].color[2]/255, (oL[3]/255)*object[i].color[3]/255)
									end
								end
							elseif object.objType == 4 then
								local oL = object.light.source
								for i = 1, object.numChildren, 1 do
									if object[i]._class then
										object[i]:setStrokeColor((oL[1]/255)*object[i].color[1]/255, (oL[2]/255)*object[i].color[2]/255, (oL[3]/255)*object[i].color[3]/255)
									end
								end
							end
						end
					...
					if object.lighting then
						if M.enableLighting then
							...
							local red, green, blue = map.layers[i].redLight, map.layers[i].greenLight, map.layers[i].blueLight
							if map.perlinLighting then
								red = red * (map.perlinLighting[locX][locY] / 255)
								green = green * (map.perlinLighting[locX][locY] / 255)
								blue = blue * (map.perlinLighting[locX][locY] / 255)
							elseif map.layers[i].perlinLighting then
								red = red * (map.layers[i].perlinLighting[locX][locY] / 255)
								green = green * (map.layers[i].perlinLighting[locX][locY] / 255)
								blue = blue * (map.layers[i].perlinLighting[locX][locY] / 255)
							end
							for k = 1, #map.layers, 1 do
								if map.layers[k].lighting[locX] then
									if map.layers[k].lighting[locX][locY] then
							...
							if tileObjects[i][locX] and tileObjects[i][locX][locY] then
								...
								if not rect.noDraw then	
									...
									if map.lightToggle[locX][locY] and map.lightToggle[locX][locY] > map.lightToggle2[locX][locY] then
										...
										rect:setFillColor(rect.color[1]/255, rect.color[2]/255, rect.color[3]/255)
									end								
								end
							end
						end
				...
				for x = masterGroup[i].vars.camera[1], masterGroup[i].vars.camera[3], 1 do
					for y = masterGroup[i].vars.camera[2], masterGroup[i].vars.camera[4], 1 do
						if tileObjects[i][x] and tileObjects[i][x][y] and not tileObjects[i][x][y].noDraw then
							tileObjects[i][x][y]:setFillColor(map.layers[i].redLight/255, map.layers[i].greenLight/255, map.layers[i].blueLight/255)
		...
		for key,value in pairs(tintingTiles) do
			...
			tile:setFillColor(tile.currentColor[1]/255, tile.currentColor[2]/255, tile.currentColor[3]/255)
		...
		if deltaZoom then
			if M.g2 then
				local tempX = ((currentScale - (currentScale - deltaZoom[1])) * display.viewableContentWidth) / 2
				local tempY = ((currentScale - (currentScale - deltaZoom[1])) * display.viewableContentHeight) / 2
	...
	M.constrainCamera = function(parameters)
		...
		elseif parameters.pos then
			leftParam = parameters.pos[1]
			topParam = parameters.pos[2]
			rightParam = parameters.pos[3]
			bottomParam = parameters.pos[4]
		else
			leftParam = 0
			topParam = 0
		...
		for x = 1, width, 1 do
			for y = 1, height, 1 do
				...
				if parameters.lighting then
					...
					local perlinData = ((perlinData[x][y] / maxVal) * (parameters.lighting.scale or 255)) + offset
